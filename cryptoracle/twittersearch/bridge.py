...
def get_tweets(search_term, max_results='10', next_token=None, start_time=None, end_time=None):
    ...
    query = 'https://api.twitter.com/2/tweets/search/recent?query="{}" lang:en -is:retweet&max_results={}{}{}{}'.format(
            requests.utils.quote(search_term), 
            max_results, 
            next_page_query, 
            start_time_query,
            end_time_query
